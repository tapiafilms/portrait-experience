...
const buildPrompt = () =>
  `The image shows a PERSON — transform them into a premium Pixar 3D animated character that is instantly and unmistakably recognizable as that same person: preserve their exact face structure, hair color and style, eye color, skin tone, facial hair and any distinctive features, faithfully translated into Pixar art style. Render quality like Coco, Up or Soul. The character should have big expressive Pixar eyes, smooth subsurface scattering skin, detailed hair grooming. Improve posture naturally: confident and charismatic stance, relaxed shoulders. CRITICAL: preserve the character's exact facial expression from the original photo — if they look serious, keep them serious; if neutral, keep neutral; if smiling, keep smiling. Do NOT add a smile or change the expression. Preserve and enhance original clothing with premium quality. Background: elegant outdoor corporate event at night, warm golden string lights, purple and blue accent lighting, guests socializing in the background, bokeh, luxury cocktail atmosphere. Cinematic Pixar lighting with warm key light on face, soft rim light, golden highlights. Mood: celebration, success, innovation. Ultra high quality, 8K Pixar feature film render.`

const NEGATIVE = `low quality, blurry, generic cartoon, anime, flat 2D, distorted face, wrong facial proportions, different person, exaggerated caricature, plastic skin, creepy eyes, extra fingers, bad anatomy, low resolution, childish, text, watermark, smile, happy expression, added smile`
